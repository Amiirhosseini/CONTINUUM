...
CONTINUUM is now open source under Apache-2.0. Community contributions for fixes, documentation, integrations, and testing are welcome and credited in [AUTHORS.md](AUTHORS.md) and [graphs/contributors](https://github.com/Cyrax321/CONTINUUM/graphs/contributors).

**About me:** I am **Anandhu P Shaji** ([@Cyrax321](https://github.com/Cyrax321) · [LinkedIn](https://www.linkedin.com/in/anandhupshaji/)), the original creator and maintainer. I designed the architecture, wrote the core substrate, and ship the roadmap and releases. Contributors are acknowledged as contributors, and the direction of the project remains curated by the original creator to keep the design coherent as it evolves.

**Roles:** Creator and Maintainer: Anandhu P Shaji.
