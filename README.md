...
The project is now open source under Apache-2.0. Community contributions for fixes, documentation, integrations, and testing are welcome and credited in [AUTHORS.md](AUTHORS.md) and [graphs/contributors](https://github.com/Cyrax321/CONTINUUM/graphs/contributors). Architecture, roadmap, and releases remain curated by the original creator to keep the design coherent as it evolves.

**Roles:** Creator and Maintainer: Anandhu P Shaji. Contributors are acknowledged as contributors.
